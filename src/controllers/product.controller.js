...
class ProductController {
    ...
    delete = async ( req, res, next ) => {
        new SuccessResponse({
            ...
            metadata: await ProductFactory.deleteProduct(
    ...
    getAllProductsByShop = async ( req, res, next ) => {
        new SuccessResponse({
            ...
            metadata: await ProductFactory.getAllProductsByShop(
                req.user.userId
            )
        }).send(res)
    }
    getProductDraftsByShop = async ( req, res, next ) => {
        new SuccessResponse({
            ...
            metadata: await ProductFactory.getProductDraftsByShop(
                req.user.userId
            )
        }).send(res)
    }
    ...
    filterProduct = async ( req, res, next ) => {
        new SuccessResponse({
            ...
            metadata: await ProductFactory.filterProduct(
                req.query
            )
        }).send(res)
    }
    ...
    updateProductDraft = async ( req, res, next ) => {
        new SuccessResponse({
            ...
            metadata: await ProductFactory.updateProductDraft(
                req.params.product_id
            )
        }).send(res)
    }
